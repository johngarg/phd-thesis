...
\begin{table}
  \begin{center}
    ...
    SMEFT that are not four-fermion operators.]{The table shows the operators
      ...
      the reader to Appendix~\ref{chapter:notation} for the correspondence
      between the four-component notation used here and the two-component
      notation used elsewhere in this work for spinors, along with the
      definition of $\bar{D}^{\mu}$. Flavor indices are omitted and should be
      understood to act on fermions in the order $\{r, s\}$ as they appear in
      each operator. \label{tab:ch1-smeft-d6-other}}
  \end{center}
\end{table}
