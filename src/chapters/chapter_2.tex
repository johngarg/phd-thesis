...
Section~\ref{sec:ch2-conventions} sets out some conventions.
Section~\ref{sec:ch2-treelevelmatching} contains a review of tree-level matching and
...
section~\ref{sec:ch2-modelbuilding}, while section~\ref{sec:ch2-models} presents a
...
\begin{figure}[t]
  ...
  topologies.]{\textit{Above:} Scalar-only and fermion-only topologies which
    ...
    connection to Eq.~\eqref{eq:ch2-seesaw-contractions}. The exotic propagators are
    shown in bold.}
