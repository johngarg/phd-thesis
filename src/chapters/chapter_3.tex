...
\begin{figure}
  ...
  \begin{minipage}[t]{\linewidth}
    \centering \includegraphics[width=0.6\linewidth]{newcllclr.png}
    \subcaption[The results of scan I (black) and scan II (red) projected onto
    the $C_{LL}^{S_{1}}$--$C_{LR}^{S_{1}}$ plane.]{{\color{red}Needs to be
        updated, original figure depricated.}The results of scan I (black) and
      scan II (red) projected onto the $C_{LL}^{S_{1}}$--$C_{LR}^{S_{1}}$ plane.
      The coloured contours correspond to those in Fig.~\ref{fig:ch3-cllclr}:
      the orange represent the fit to only LFU observables while the blue take
      into account all $b\to s$ observables. The model can alleviate the
      tensions in LFU observables to just within the $1\sigma$ region, a
      significant improvement on the SM. In this region,
      $C_{LR}^{S_{1}} \approx 0$, implying a suppression of the $y_{2r}$.
      Agreement with all of the $b \to s$ data is not as good.\\}
